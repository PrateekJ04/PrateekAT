...
class Test_Crud_Better(object):
    ...
    def test_put_booking(self, get_booking, get_token):
        response = apiwrapper.put_request(
            url=Api_Constants.put_patch_delete_url(bookingid=get_booking),
    ...
    def test_delete_booking(self, get_booking, get_token):
